...
public class MySqlUtilities implements DbUtilities{
    ...
    private String dbName = "nas162_bank1017"; // default database name
    private String dbUserName = "nas162"; // login name for the database server
    private String dbPassword = "3764534"; // password for the database server
